...
namespace Esp8266_Animatron.Controllers
{
  ...
  public class ValuesController : ControllerBase
  {
    ...
    public ActionResult<string> Get(int id)
    {
      ...
      Fonts.PrintSymbol(21, 8, 24);
      Fonts.PrintSymbol(21, 16, 24);
      Fonts.PrintSymbol(21, 24, 24);
      Fonts.PrintSymbol(21, 32, 24);
      Fonts.PrintSymbol(21, 40, 24);
      Fonts.PrintSymbol(21, 48, 24);
